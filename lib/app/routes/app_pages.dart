...
import 'package:lavoro/app/modules/emp_home/emp_home/views/emp_home_view.dart';
...
import '../modules/emp_home/emp_home/bindings/emp_home_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    //   page: () => SendOTPView(), // Make sure to define SendOTPView
    // ),
    GetPage(
      name: _Paths.EMPHOME,
